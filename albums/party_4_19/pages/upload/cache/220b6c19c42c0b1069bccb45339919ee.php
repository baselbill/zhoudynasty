...
<input type="text" name="uploader_url" id="uploader_url" size="70" value="'; print @$_vars['uploader_url'] . '"/>
</div>

<div class="white">
<strong>Admin email</strong></br>
Your email incase the users have any questions.<br />
<input type="text" name="admin_email" id="admin_email" size="70" value="' . (isset($_vars['admin_email']) ? @$_vars['admin_email'] : 'admin@domain.com') . '"/>
</div>
...
<textarea name="incoming_directories" id="incoming_directories" cols="96" rows="8">'; print @$_vars['incoming_directories'] . '</textarea>
<br />
Your absolute path based on information from $_SERVER: '; print @$_vars['_SERVER']['SCRIPT_FILENAME'] . '
</div>

<div class="gray">
<strong>Password Required</strong><br />
This requires that a user enter a username and password before using the uploader.<br />
<input type="radio" name="password_required" id="password_required" value="1" '; if( @$_vars['password_required']) { print 'checked="checked"';}print'/> Yes
<input type="radio" name="password_required" id="password_required" value="0" '; if( !@$_vars['password_required']) { print 'checked="checked"';}print'/> No
</div>

<div class="white">
<strong>Registration</strong><br />
Enable or disable registration of new users.<br />
<input type="radio" name="allow_register" id="allow_register" value="1" '; if( @$_vars['allow_register']) { print 'checked="checked"';}print'/> Enable
<input type="radio" name="allow_register" id="allow_register" value="0" '; if( !@$_vars['allow_register']) { print 'checked="checked"';}print'/> Disable
</div>
...
<input type="radio" name="logging" id="logging" value="1" '; if( @$_vars['logging']) { print 'checked="checked"';}print'/> Log
<input type="radio" name="logging" id="logging" value="0" '; if( !@$_vars['logging']) { print 'checked="checked"';}print'/> Don\'t Log
</div>
...
<input type="radio" name="auto_approve" id="auto_approve" value="1" '; if( @$_vars['auto_approve']) { print 'checked="checked"';}print'/> Auto
<input type="radio" name="auto_approve" id="auto_approve" value="0" '; if( !@$_vars['auto_approve']) { print 'checked="checked"';}print'/> Manual
</div>
...
HTML will work.<br />
<textarea name="comments" id="comments" cols="70" rows="8">'; print @$_vars['comments'] . '</textarea>
</div>
...
<br />
<input type="text" name="max_file_size" id="max_file_size" size="3" value="'; print @$_vars['max_file_size'] . '"/>
</div>
...
a good number.
<br />
<input type="text" name="default_upload_fields" id="default_upload_fields" size="3" value="'; print @$_vars['default_upload_fields'] . '"/>
</div>
...
<br />
<input type="text" name="max_upload_fields" id="max_upload_fields" size="3" value="'; print @$_vars['max_upload_fields'] . '"/>
</div>
...
<br />
<input type="text" name="allowed_types" id="allowed_types" size="70" value="'; print @$_vars['allowed_types'] . '"/>
</div>
...
<br />
<input type="radio" name="image_only" id="image_only" value="1" '; if( @$_vars['image_only']) { print 'checked="checked"';}print'/> Yes
<input type="radio" name="image_only" id="image_only" value="0" '; if( !@$_vars['image_only']) { print 'checked="checked"';}print'/> No
</div>
...
<br />
<input type="radio" name="allow_php" id="allow_php" value="1" '; if( @$_vars['allow_php']) { print 'checked="checked"';}print'/> Yes
<input type="radio" name="allow_php" id="allow_php" value="0" '; if( !@$_vars['allow_php']) { print 'checked="checked"';}print'/> No
</div>
...
<br />
<input type="radio" name="allow_browsing" id="allow_browsing" value="1" '; if( @$_vars['allow_browsing']) { print 'checked="checked"';}print'/> Yes
<input type="radio" name="allow_browsing" id="allow_browsing" value="0" '; if( !@$_vars['allow_browsing']) { print 'checked="checked"';}print'/> No
</div>
...
<br />
<input type="radio" name="allow_override" id="allow_override" value="1" '; if( @$_vars['allow_override']) { print 'checked="checked"';}print'/> Yes
<input type="radio" name="allow_override" id="allow_override" value="0" '; if( !@$_vars['allow_override']) { print 'checked="checked"';}print'/> No
</div>
...
<br />
<input type="radio" name="show_comments" id="show_comments" value="1" '; if( @$_vars['show_comments']) { print 'checked="checked"';}print'/> Yes
<input type="radio" name="show_comments" id="show_comments" value="0" '; if( !@$_vars['show_comments']) { print 'checked="checked"';}print'/> No
</div>
...
<br />
<input type="radio" name="show_rules" id="show_rules" value="1" '; if( @$_vars['show_rules']) { print 'checked="checked"';}print'/> Yes
<input type="radio" name="show_rules" id="show_rules" value="0" '; if( !@$_vars['show_rules']) { print 'checked="checked"';}print'/> No
</div>
