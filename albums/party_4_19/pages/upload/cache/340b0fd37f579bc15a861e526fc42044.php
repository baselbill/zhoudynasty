...
';for($i=0; $i<count($_vars['incoming_directories']); $i++){print'<a href="index.php?action=browse&amp;in='; print @$_vars['incoming_directories'][$i] . '">'; print @$_vars['incoming_directories'][$i] . '</a> 
';}print'
<br /><br />
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td style="border-bottom: 1px #CC6600 solid;"><a class="orange" title="Sort this column." href="index.php?action=browse&amp;dir='; print @$_vars['current_dir'] . '&amp;in='; print @$_vars['browse_in'] . '&amp;sortby=name&amp;order='; if( @$_vars['order'] == 'asc') { print 'dsc';}else{print'asc';}print'">File Name</a>'; if( @$_vars['sortby'] == 'name') { print '  <img src="images/'; if( @$_vars['order'] == 'asc') { print 'up.gif';}else{print'down.gif';}print'" alt="" />';}print'</td>
    <td style="border-bottom: 1px #CC6600 solid;"><a class="orange" title="Sort this column." href="index.php?action=browse&amp;dir='; print @$_vars['current_dir'] . '&amp;in='; print @$_vars['browse_in'] . '&amp;sortby=size&amp;order='; if( @$_vars['order'] == 'asc') { print 'dsc';}else{print'asc';}print'">Size</a>'; if( @$_vars['sortby'] == 'size') { print '  <img src="images/'; if( @$_vars['order'] == 'asc') { print 'up.gif';}else{print'down.gif';}print'" alt="" />';}print'</td>
    <td style="border-bottom: 1px #CC6600 solid;"><a class="orange" title="Sort this column." href="index.php?action=browse&amp;dir='; print @$_vars['current_dir'] . '&amp;in='; print @$_vars['browse_in'] . '&amp;sortby=time&amp;order='; if( @$_vars['order'] == 'asc') { print 'dsc';}else{print'asc';}print'">Uploaded</a>'; if( @$_vars['sortby'] == 'time') { print '  <img src="images/'; if( @$_vars['order'] == 'asc') { print 'up.gif';}else{print'down.gif';}print'" alt="" />';}print'</td>
    <td style="border-bottom: 1px #CC6600 solid;"><a class="orange" title="Sort this column." href="index.php?action=browse&amp;dir='; print @$_vars['current_dir'] . '&amp;in='; print @$_vars['browse_in'] . '&amp;sortby=type&amp;order='; if( @$_vars['order'] == 'asc') { print 'dsc';}else{print'asc';}print'">Type</a>'; if( @$_vars['sortby'] == 'type') { print '  <img src="images/'; if( @$_vars['order'] == 'asc') { print 'up.gif';}else{print'down.gif';}print'" alt="" />';}print'</td>
  ...
  <tr>
    ...
    <td style="border-top: 1px #CC6600 solid;">&nbsp;<input type="hidden" name="dir" id="dir" value="'; print @$_vars['current_dir'] . '" /><input type="hidden" name="browse_in" id="browse_in" value="'; print @$_vars['browse_in'] . '" /></td>
