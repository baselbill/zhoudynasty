...
<textarea name="allowed_urls" cols="90" rows="12">'; print @$_vars['allowed_urls'] . '</textarea><br />
<p>Redirect denied requests to:</p>
<input type="text" value="'; print @$_vars['redirect_url'] . '" name="redirect_url" size="80" /><br />
File types to protect, seperate them with the pipe | symbold:<br />
<input type="text" value="'; print @$_vars['file_types'] . '" name="file_types" size="80" /><br />
